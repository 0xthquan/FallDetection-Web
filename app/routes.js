...
module.exports = function (app, passport) {
    ...
    //         var sql = "update account set name = ? , email = ? , phone_number = ? , address = ? where  ?";
    //         connection.query(sql, [name, email, phone, address, { username: req.query.user }], (err, result) => {
    //             if (err) throw err;
    //         });
    //     } else {
    //         var password = req.body.password;
    //         var sql = "update account set name = ? , password = ? , email = ? , phone_number = ? , address = ? where  ?";
    ...
    //     var sql = "select * from account where username = '" + req.query.user + "'";
    //     connection.query(sql, (err, result) => {
    //         if (err) throw err;
